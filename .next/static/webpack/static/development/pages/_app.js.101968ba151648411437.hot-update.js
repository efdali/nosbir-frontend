...
function NotificationPanel(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      key: i,
      className: "jsx-2324655004" + " " + ((n.is_viewed === false ? "not-viewed" : n.is_viewed) || "")
