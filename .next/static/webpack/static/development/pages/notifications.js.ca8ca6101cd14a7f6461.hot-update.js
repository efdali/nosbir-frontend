...
function Notifications(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (data.length === 0) {
      setLoading(true);
      _utils_http__WEBPACK_IMPORTED_MODULE_6__["default"].get("bildirimler.php", {
        params: {
          howMany: "all"
        }
      }).then(function (res) {
    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _utils_http__WEBPACK_IMPORTED_MODULE_6__["default"].get("bildirimler.php", {
              params: {
                howMany: "all"
              }
            }).then(function (res) {
              if (res.durum) return res.data.bildirimler;else return [];
            });
...
//# sourceMappingURL=notifications.js.ca8ca6101cd14a7f6461.hot-update.js.map