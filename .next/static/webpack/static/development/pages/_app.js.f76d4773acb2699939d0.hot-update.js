...
function NotificationPanel(_ref) {
  ...
  return __jsx("div", {
    className: "jsx-626876422" + " " + "notification-panel ".concat(active ? "active" : "")
  }, __jsx("ul", {
    className: "jsx-626876422"
  }, isLoading && __jsx(_loading__WEBPACK_IMPORTED_MODULE_4__["default"], null), notifications.length > 0 && notifications.map(function (n, i) {
    return __jsx("li", {
      key: i,
      className: "jsx-626876422" + " " + ((n.is_viewed ? "not-viewed" : "") || "")
