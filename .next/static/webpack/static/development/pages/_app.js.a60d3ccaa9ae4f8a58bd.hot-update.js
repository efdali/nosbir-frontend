...
function NotificationPanel(_ref) {
  ...
  return __jsx("div", {
    ...
    return __jsx("li", {
      key: i,
      className: "jsx-2324655004" + " " + ((n.is_viewed == true ? "" : "not-viewed") || "")
